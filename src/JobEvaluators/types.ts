export type JobRecommendation = "strong_apply" | "apply" | "maybe" | "skip";

export type GapSeverity = "minor" | "moderate" | "major" | "disqualifying";

export type GapType = "learnable" | "transferable" | "experience" | "domain" | "structural" | "career_risk";
