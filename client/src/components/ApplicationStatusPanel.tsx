...
function ApplicationStatusPanel({ jobPostId, onStatusSaved }: ApplicationStatusPanelProps) {
                ...
                <>
                    ...
                    <div className="form-group">
                        ...
                        <p className="attachments-description">
                            Upload anything related to this job post or the application process, such as resumes, cover
                                        ...
                                        <tr>
                                            ...
                                            <th onClick={() => handleSort("fileName")}>
                                                <div className="sortable-header">
                                                    ...
                                                    <span className="sort-icon">
                                                        {getSortIndicator("fileName", sortColumn, sortDirection)}
                                                    </span>
                                                </div>
                                            </th>
                                            <th onClick={() => handleSort("dateAdded")}>
                                                <div className="sortable-header">
                                                    ...
                                                    <span className="sort-icon">
                                                        {getSortIndicator("dateAdded", sortColumn, sortDirection)}
                                                    </span>
                                                </div>
                                            </th>
                                        </tr>
